...
const LiveSchedule = require('./models/LiveSchedule');   // ← Now it will find the file
...
// ====================== MARK LECTURE AS COMPLETED (Manual Tick) ======================
app.patch('/api/lectures/:id/complete', authenticateAdmin, async (req, res) => {   // ← Protected with authenticateAdmin
  try {
